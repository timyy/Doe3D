(function () {
    ...
    (function () {
        ...
        Function.prototype.bind || (Function.prototype.bind = function (a) {
            ...
            var c = Array.prototype.slice.call(arguments, 1), d = this, e = function () {
            }, f = function () {
    ...
    ERNO.extend = function (a, b) {
        if (Object.keys)for (var c = Object.keys(b), d = 0, e = c.length;
                             d < e;
                             d++) {
            var f = c[d];
    ...
    THREE.CSS3DRenderer = function () {
        var a, b, c, d, e = new THREE.Matrix4, f = document.createElement("div");
        ...
        var g = function (a) {
            ...
            var a = new THREE.Vector3, b = new THREE.Vector3, c = new THREE.Euler, e = new THREE.Quaternion;
            c._quaternion = e;
            e._euler = c;
            return function (d) {
                d.decompose(a, e, b);
    ...
    ERNO.extend(String.prototype, {
        capitalize: function () {
            ...
            var b = Math.round(this.length / 2), c = this.length - b, d = Math.round(a / 2), b = d - b;
            a = a - d - c;
            c = this;
            if (0 < b)for (;
                b--;
            ...
            var a = "N NNE NE NEE E SEE SE SSE S SSW SW SWW W NWW NW NNW N".split(" "), b = a.indexOf(this.toUpperCase());
        ...
        toUnicode: function () {
            ...
            for (a = 0;
                 a < this.length;
                 a++) {
                for (b = this.charCodeAt(a).toString(16).toUpperCase();
                     4 > b.length;
                )b = "0" + b;
                c += "\\u" + b
            }
    ...
    W = ERNO.WHITE = new ERNO.Color("white", "W", "#FFF", "font-weight: bold; color: #888 ",
        "background - color : #F3F3F3; color: rgba(0, 0, 0, 0.5)");
    O = ERNO.ORANGE = new ERNO.Color("orange", "O", "#F60", "font-weight: bold; color: #F60",
        "background - color : #F60; color: rgba(255, 255, 255, 0.9)");
    B = ERNO.BLUE = new ERNO.Color("blue", "B", "#00D", "font-weight: bold; color: #00D",
        "background - color : #00D; color: rgba(255, 255, 255, 0.9)");
    R = ERNO.RED = new ERNO.Color("red", "R", "#F00", "font-weight: bold; color: #F00",
        "background - color : #F00; color: rgba(255, 255, 255, 0.9)");
    G = ERNO.GREEN = new ERNO.Color("green", "G", "#0A0", "font-weight: bold; color: #0A0",
        "background - color : #0A0; color: rgba(255, 255, 255, 0.9)");
    Y = ERNO.YELLOW = new ERNO.Color("yellow", "Y", "#FE0", "font-weight: bold; color: #ED0",
    ...
    ERNO.Direction.getIdByName = function (a) {
        return {front: 0, up: 1, right: 2, down: 3, left: 4, back: 5}[a]
    };
    ...
    ERNO.Twist.validate = function () {
        var a = Array.prototype.slice.call(arguments), b, c, d, e, f, h;
        for (c = 0;
             c < a.length;
    ...
    ERNO.extend(ERNO.Cubelet.prototype, {
        setAddress: function (a) {
            ...
            for (a = 0;
                 6 > a;
                 a++)if (c = _.hexToRgb(this.faces[a].color.hex), c.r === d.r && c.g === d.g && c.b === d.b) {
                b = a;
                break
            }
            ...
            if (!1 === this.isTweening && (a = a || 0, void 0 === this.radius && (this.radius = 0), this.radius !== a)) {
                ...
                (new TWEEN.Tween(d)).to({radius: a}, c).easing(TWEEN.Easing.Quartic.Out).onUpdate(function () {
    ...
    ERNO.extend(ERNO.Group.prototype, {
        add: function () {
            ...
            for (var c = this.cubelets.length;
                 0 < c--;
        ...
        hasAddress: function (a) {
            ...
            var a = new ERNO.Group, b = Array.prototype.slice.call(arguments);
            this.cubelets.forEach(function (c) {
    ...
    ERNO.Slice = function (a, b) {
        ...
        this.rotateGroupMappingOnAxis = function () {
            var c = new THREE.Vector3, d = new THREE.Vector3(1, 1, 1), e = new THREE.Vector3, f = new THREE.Vector3, h = new THREE.Matrix4, g;
            return function (m) {
    ...
    ERNO.extend(ERNO.Slice.prototype, {
        ...
        get cubelets() {
            for (var a = [], b = this.indices.length;
                 0 < b--;
            ...
            for (var c = 0;
                 6 > c;
                 c++)if (this.origin.faces[c].color && this.origin.faces[c].color !== ERNO.COLORLESS) {
                this.color = this.origin.faces[c].color;
                this.face = ERNO.Direction.getNameById(c);
                break
            }
            if (void 0 === this.axis || 0 === this.axis.lengthSq()) {
                var c = this.northEast.position.clone(), d = this.southWest.position.clone(), e = this.northWest.position.clone();
            ...
            for (var c = new THREE.Matrix4;
                 a--;
            )b = this.getCubelet(a), b.matrix.multiplyMatrices(this.matrix, b.matrixSlice), b.position.setFromMatrixPosition(b.matrix), b.scale.setFromMatrixScale(b.matrix), c.extractRotation(b.matrix), b.quaternion.setFromRotationMatrix(c)
        }, get rotation() {
            ...
            if (a) {
                var b = {}, c, d = this.indices.length, e = 0;
                a instanceof ERNO.Direction && (a = a.name);
                for (;
                    0 < d--;
    ...
    ERNO.Projector = function () {
        return function (a, b) {
            ...
            var e, f = new THREE.Matrix4, h = new THREE.Matrix4, g = new THREE.Vector3, m = new THREE.Vector3(1, 1, 1), s = new THREE.Vector3, q = new THREE.Ray, p = new THREE.Box3, k = new THREE.Sphere, l = new THREE.Matrix4, u = g.distanceTo(m);
    ...
    ERNO.Interaction = function () {
        return function (a, b, c, d, e) {
            ...
            var m = new ERNO.Projector(a, c), s = new THREE.Vector3, q, p, k, l, u, A = new THREE.Vector3, n = !1, w = new THREE.Plane, t = new THREE.Vector3, D = new THREE.Vector3, x = new THREE.Vector2;
            new THREE.Vector3;
            ...
            v.getIntersectionAt = function () {
                var a = new THREE.Vector3, c = new THREE.Plane;
                return function (e, d) {
            ...
            c.addEventListener("touchend", function (a) {
                var b = a.changedTouches[0].clientX, c = a.changedTouches[0].clientY;
    ...
    ERNO.Controls = function () {
        ...
        return function (c, d, e) {
            ...
            var p = -1, k = new THREE.Vector2, l = new THREE.Vector2;
            new THREE.Vector2;
            var u = new THREE.Vector2, A = new ERNO.Projector(c, e), n = {
                enabled: !0,
                domElement: e,
                rotationSpeed: 4,
                damping: 0.25
            ...
            n.update = function () {
                var e = new THREE.Vector3, f = 0, g = new THREE.Matrix4;
                return function () {
    ...
    ERNO.renderers.CSS3D = function (a, b) {
        ...
        function f() {
            if (b.domElement.parentNode) {
                var a = b.domElement.parentNode.clientWidth, c = b.domElement.parentNode.clientHeight;
    ...
    ERNO.renderers.CSS3DCubelet.methods = function () {
        ...
        return {
            getFaceElements: function (a) {
                ...
                var b = new THREE.Vector3, d = new THREE.Matrix4, e;
                return function (f, h) {
                    e = "";
                ...
                var a = new THREE.Vector3, d = new THREE.Matrix4, e;
                return function (f, h) {
                    e = "";
                ...
                void 0 === a && (a = 1);
                if (a !== this.opacity) {
                    var e = this, f = (a - this.opacity).absolute().scale(0, 1, 0, 200);
                    this.opacityTween = (new TWEEN.Tween({opacity: this.opacity})).to({opacity: a}, f).easing(TWEEN.Easing.Quadratic.InOut).onUpdate(function () {
    ...
    ERNO.Cube = function (a) {
        ...
        this.camera = new THREE.PerspectiveCamera(35, window.innerWidth / window.innerHeight, 1, 6E3);
        ...
        [[W, O, , , G], [W, O, , , ,], [W, O, B, , ,], [W, , , , G], [W, , , , ,], [W, , B,
            , ,], [W, , , R, G], [W, , , R, ,], [W, , B, R, ,], [, O, , , G], [, O, , , ,], [, O, B, , ,], [, , , , G], [, , , , ,], [, , B, , ,], [, , , R, G], [, , , R, ,], [, , B, R, ,], [, O, , , G, Y], [, O, , , , Y], [, O, B, , , Y], [, , , , G, Y], [, , , , , Y], [, , B, , , Y], [, , , R, G, Y], [, , , R, , Y], [, , B, R, , Y]].forEach(function (a, b) {
        ...
        var c = function (a) {
            this.dispatchEvent(new CustomEvent("onTwistComplete", {detail: {slice: a.target}}))
        }.bind(this);
